...
export default class Coachmark extends Component {
  constructor(props) {
    ...
    this._renderCoachmark = () => {
      return React.createElement(
        ...
        React.createElement(CoachmarkView, {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        View,
        { ref: this.view, style: contentContainerStyle, onLayout: this._measureLayout },
      ...
      React.createElement(
        ...
        this.state.position === 'bottom'
          ? React.createElement(React.Fragment, null, this._renderCoachmark(), this._renderChildren())
          : React.createElement(React.Fragment, null, this._renderChildren(), this._renderCoachmark()),
        React.createElement(
          TouchableWithoutFeedback,
          { accessibilityLabel: accessibilityLabel, testID: testID, onPress: this.hide },
