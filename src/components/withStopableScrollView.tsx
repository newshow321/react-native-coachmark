...
export default function (WrappedComponent) {
    var _a;
    const StopableScroll = (_a = class extends React.Component {
            constructor() {
                super(...arguments);
                this.yOffset = 0;
            ...
            render() {
                return (React.createElement(WrappedComponent, Object.assign({}, this.props, { ref: this.props.scrollViewRef || this.scrollView, onScroll: this._handleOnScroll, scrollEventThrottle: 16 })));
            }
        },
        _a.defaultProps = {
