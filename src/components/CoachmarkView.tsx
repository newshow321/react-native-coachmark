...
export default class CoachmarkView extends Component {
    ...
    render() {
        return this.props.position === CoachmarkPosition.TOP ? (React.createElement(React.Fragment, null,
            this.renderCoachmarkArrow(),
            this.renderCoachmarkContent())) : (React.createElement(React.Fragment, null,
